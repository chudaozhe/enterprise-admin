<template>
  <div class="all-img-item">
    <div :class="['img_box']" @click="selected">
      <div class="select_status">
        <i class="vue-picture-manager-icon"></i>
      </div>

      <div class="info_panel">{{ imgWidth }} x {{ imgHeight }}</div>

      <!--			<div class="func_panel" @click.stop="deleteItem">-->
      <!--				<div class="func_item" >-->
      <!--					<i class="vue-picture-manager-icon icon-ai-delete" style="font-size: 12px;"></i>-->
      <!--				</div>-->
      <!--			</div>-->

      <img :src="host + file.url" alt="" />
    </div>
  </div>
</template>
