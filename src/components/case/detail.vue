			...
			<div class="">
				<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
					...
					<el-form-item label="排序" prop="sort">
						<el-input v-model="ruleForm.sort"></el-input><div style="color: gray">值越大越靠前</div>
					</el-form-item>
					<el-form-item label="是否显示" prop="status">
						<el-input v-model="ruleForm.status"></el-input><div style="color: gray">是否显示：1是 0否</div>
					</el-form-item>
...
<script>
	...
	import { get,add,edit } from '../../model/admin/case'
			...
			detail: async function () {
				if(this.id>0){
					...
					if(result.err===0){
						...
						this.ruleForm.category_ids=[parseInt(field.category_id)];
						...
						if(''!==field.image) this.image=field.image;
...
//                      params: null, //键值对,指定文件上传接口的额外参数,上传的时候随文件一起提交
			...
			submitForm(formName) {
				...
				this.$refs[formName].validate((valid) => {
					...
					if (valid) {
						let data={};
						data.category_id=_this.ruleForm.category_ids[0];
